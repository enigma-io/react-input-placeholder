 ...
 */
var createInput = function(React) {
...
var createTextarea = function(React) {
  return React.createClass({
    ...
    render: function() {
      var textarea = this.transferPropsTo(React.DOM.textarea());
      if (this.needsPlaceholding) {
        // override valueLink and event handlers
        textarea.props.onFocus = this.onFocus;
        textarea.props.onBlur = this.onBlur;
        textarea.props.onChange = this.onChange;
        textarea.props.onSelect = this.onSelect;
        textarea.props.valueLink = undefined;

        var value = this.getValue();
        if (!value) {
          this.isPlaceholding = true;
          value = this.props.placeholder;
          textarea.props.type = 'text';
          textarea.props.className += ' placeholder';
        } else {
          this.isPlaceholding = false;
        }
...
module.exports = function(React) {
  return {
    Input: createInput(React),
    Textarea: createTextarea(React)
  }
};
